<?php
add_action('tgmpa_register', 'kb_theme_register_required_plugins');
/**
 ...
 *
 */
if (!function_exists('kb_theme_register_required_plugins')) {
    function kb_theme_register_required_plugins()
    {
         ...
         */
        $plugins = array(
            /* bbPress plugin is required for forums */
            array(
                'name' => 'bbPress',
                'slug' => 'bbpress',
                'required' => false,
